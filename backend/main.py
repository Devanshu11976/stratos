    ...
    DEFAULT_RULES = [
        {
            ...
            "valid_payment_modes": ["NETBANKING", "UPI", "CARD", "CASH"],
        },
        {
            "country_code": "SG",
            ...
            "phone_regex": r"^\d{8,12}$",
            "date_format": "DD-MM-YYYY",
            "valid_payment_modes": ["NETBANKING", "CARD", "CASH", "PAYNOW", "NETS"],
        },
        {
            "country_code": "US",
            "country_name": "USA",
            ...
            "valid_payment_modes": ["NETBANKING", "CARD", "ACH", "WIRE", "PAYPAL", "CASH"],
        },
        {
            "country_code": "DE",
            ...
            "phone_regex": r"^\d{8,12}$",
            "date_format": "DD.MM.YYYY",
            "valid_payment_modes": ["NETBANKING", "CARD", "SEPA", "CASH", "PAYPAL"],
        },
        {
            "country_code": "GB",
